...
{
    public partial class formCVSSTargets : Form
    {
        ...
        public formCVSSTargets(riskcard parmcard)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        public formCVSSTargets(riskcard parmcard, Boolean enabledebug)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        private void formCVSSTargets_Shown(object sender, EventArgs e)
        {
            this.setformtocard();
        }
        ...
        */
        ...
        private void formCVSSTargets_Load(object sender, EventArgs e)
        {
