...
{
    public partial class formCVSS : Form
    {
        ...
        public formCVSS(riskcard parmcard)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        public formCVSS(riskcard parmcard, Boolean enabledebug)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        private void formCVSS_Shown(object sender, EventArgs e)
        {
            this.setformtocard();
        }
