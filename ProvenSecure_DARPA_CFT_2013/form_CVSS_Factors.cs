...
{
    public partial class formCVSSFactors : Form
    {
        ...
        public formCVSSFactors(riskcard parmcard)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        public formCVSSFactors(riskcard parmcard, Boolean enabledebug)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        private void formCVSSFactors_Shown(object sender, EventArgs e)
        {
            this.setformtocard();
        }
        ...
        */
        ...
        private void formCVSSFactors_Load(object sender, EventArgs e)
        {
