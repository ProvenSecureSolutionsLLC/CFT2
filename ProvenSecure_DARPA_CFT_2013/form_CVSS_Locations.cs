...
{
    public partial class formCVSSLocations : Form
    {
        ...
        public formCVSSLocations(riskcard parmcard)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        public formCVSSLocations(riskcard parmcard, Boolean enabledebug)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        private void formCVSSLocations_Shown(object sender, EventArgs e)
        {
            this.setformtocard();
        }
        ...
        */
        ...
        private void formCVSSLocations_Load(object sender, EventArgs e)
        {
