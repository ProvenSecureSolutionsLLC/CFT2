...
namespace Bench
{
    public partial class formCVSSDevices : Form
    {
        ...
        public formCVSSDevices(riskcard parmcard)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        public formCVSSDevices(riskcard parmcard, Boolean enabledebug)
        {
            InitializeComponent();
            card = parmcard;
            if (card == null)
        ...
        {
            this.label_formtype.Text = formtype;
        }
        ...
        private void formCVSSDevices_Shown(object sender, EventArgs e)
        {
            this.setformtocard();
        }
        ...
        */
        ...
        private void formCVSSDevices_Load(object sender, EventArgs e)
        {
